...
{
  HostLeaf hl; 
  hl.host=Ipv4Address("10.1.1.2");
  hl.leaf=0;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.1.4");
  hl.leaf=0;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.1.6");
  hl.leaf=0;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.1.8");
  hl.leaf=0;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.2.2");
  hl.leaf=1;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.2.4");
  hl.leaf=1;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.2.6");
  hl.leaf=1;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.2.8");
  hl.leaf=1;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.3.2");
  hl.leaf=2;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.3.4");
  hl.leaf=2;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.3.6");
  hl.leaf=2;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.3.8");
  hl.leaf=2;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.4.2");
  hl.leaf=3;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.4.4");
  hl.leaf=3;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.4.6");
  hl.leaf=3;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.4.8");
  hl.leaf=3;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.5.2");
  hl.leaf=4;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.5.4");
  hl.leaf=4;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.5.6");
  hl.leaf=4;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.5.8");
  hl.leaf=4;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.6.2");
  hl.leaf=5;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.6.4");
  hl.leaf=5;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.6.6");
  hl.leaf=5;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.6.8");
  hl.leaf=5;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.7.2");
  hl.leaf=6;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.7.4");
  hl.leaf=6;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.7.6");
  hl.leaf=6;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.7.8");
  hl.leaf=6;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.8.2");
  hl.leaf=7;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.8.4");
  hl.leaf=7;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.8.6");
  hl.leaf=7;
  m_hostleaf.push_back(hl);
  hl.host=Ipv4Address("10.1.8.8");
  hl.leaf=7;
  m_hostleaf.push_back(hl);
