...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-UKCoZ3/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['tcp', 'ipv6', 'stats', 'error-model', 'wireless', 'realtime', 'energy', 'udp-client-server', 'traffic-control', 'udp', 'socket', 'routing', 'tutorial', 'matrix-topology', 'naming', 'load-balance']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/liuyuan/Documents/ns3-sp/build']
...
cfg_files = ['/home/liuyuan/Documents/ns3-sp/build/ns3/config-store-config.h', '/home/liuyuan/Documents/ns3-sp/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
